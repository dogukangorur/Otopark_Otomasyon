...
if(isset($_SESSION["kullanici_bilgi_dizisi"])){
    ...
    $kk_id=$kullaniciBilgi["k_kayit_id"];
   } 
...
if($giris=="GÜNCELLE"){
    ...
    kayitliKullaniciOturumBilgiGuncelleme($k_adi,$k_sifre,$kk_id);
    $check=true;
}
?>
<style>
    ...
    <div class="icerik">
        ...
        <div class="col-12">
             <?php if($giris=="GÜNCELLE"):?>
               ...
               OTURUM BİLGİ GÜNCELLEME
                </div>
                </div>      
            <?php endif;?>
            <form action="kullanici_oturum_duzenleme.php" method="POST">
